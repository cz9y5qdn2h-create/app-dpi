    ...
    <div className="min-h-screen" style={DARK_BG}>
      ...
      <section style={{ maxWidth: 860, margin: '0 auto', padding: '0 24px 80px' }}>
        <FadeIn>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 14, color: 'rgba(244,242,238,0.40)' }}>
              Les inscrits en liste d&apos;attente bénéficient d&apos;un tarif Early Adopter exclusif.
            </p>
          </div>
        </FadeIn>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
          {/* Early Adopter */}
          <FadeIn delay={0}>
            <div style={{ borderRadius: 22, padding: '36px 32px', background: 'rgba(200,169,110,0.06)', border: '0.5px solid rgba(200,169,110,0.28)', position: 'relative', height: '100%', boxSizing: 'border-box' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '3px 10px', borderRadius: 20, background: GOLD, marginBottom: 20 }}>
                <Star style={{ width: 10, height: 10, color: '#080808' }} />
                <span style={{ fontFamily: 'DM Mono, monospace', fontSize: 9, color: '#080808', fontWeight: 700 }}>EARLY ADOPTER</span>
              </div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 48, fontWeight: 300, color: GOLD, lineHeight: 1, marginBottom: 4 }}>-40%</div>
              <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 13, color: 'rgba(244,242,238,0.45)', marginBottom: 24 }}>
                sur le tarif public — garanti à vie sur votre compte
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 28 }}>
                {['Accès complet à toutes les fonctionnalités', 'Onboarding personnalisé 1h avec l\'équipe', 'Analyse gratuite de votre DIP actuel (valeur 250€)', 'Support prioritaire à vie'].map(f => (
              ...
              <button onClick={scrollToForm} style={{ ...btnGold, width: '100%', justifyContent: 'center', padding: '13px 24px' }}>
                Réserver ma place
              </button>
            </div>
          </FadeIn>
          ...
          {/* Standard */}
          <FadeIn delay={80}>
            <div style={{ borderRadius: 22, padding: '36px 32px', background: 'rgba(244,242,238,0.025)', border: '0.5px solid rgba(244,242,238,0.08)', height: '100%', boxSizing: 'border-box' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '3px 10px', borderRadius: 20, background: 'rgba(244,242,238,0.08)', marginBottom: 20 }}>
                <span style={{ fontFamily: 'DM Mono, monospace', fontSize: 9, color: 'rgba(244,242,238,0.40)' }}>TARIF PUBLIC</span>
              </div>
              <div style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 48, fontWeight: 300, color: 'rgba(244,242,238,0.35)', lineHeight: 1, marginBottom: 4 }}>
                ~2026
              </div>
              <div style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 13, color: 'rgba(244,242,238,0.30)', marginBottom: 24 }}>
                ouverture prévue dès la constitution d&apos;Iralink Agency
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 28 }}>
                {['Accès complet à toutes les fonctionnalités', 'Onboarding en libre-service', 'Support standard', 'Tarif plein à l\'ouverture'].map(f => (
                  <div key={f} style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                    <CheckCircle style={{ width: 14, height: 14, color: 'rgba(244,242,238,0.20)', flexShrink: 0, marginTop: 1 }} />
                    <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 12.5, color: 'rgba(244,242,238,0.28)', lineHeight: 1.5 }}>{f}</span>
                  </div>
                ))}
              </div>
              <div style={{ ...btnGhost, justifyContent: 'center', opacity: 0.5, cursor: 'default', padding: '13px 24px' }}>
